...
import org.superbiz.moviefun.albumsapi.AlbumsFixtures;
...
public class SetupController {
    ...
    private final MovieClient moviesClient;
    private final AlbumsClient albumsClient;
    private final MovieFixtures movieFixtures;
    private final AlbumsFixtures albumFixtures;

    public SetupController(MovieClient moviesClient, AlbumsClient albumsClient, MovieFixtures movieFixtures, AlbumsFixtures albumFixtures) {
